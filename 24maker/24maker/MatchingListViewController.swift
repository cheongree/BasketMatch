...
class MatchingListViewController: UIViewController, UITableViewDataSource, UITableViewDelegate { //매칭 탭 controller
    ...
    var matches: [Match] = [ // 예시 데이터
        Match(myTeam: Team(name: "CHICAGO", recruitingPosition: ["1", "3"], location: "서울시 강남구", rating: "1000", teamImage: "team1"), matchDate: "201805011350", matchLocation: "서울시 강남구"),
        Match(myTeam: Team(name: "MIAMI", recruitingPosition: ["2"], location: "인천시 서구", rating: "1300", teamImage: "team2"), matchDate: "201805011350", matchLocation: "인천시 서구"),
        Match(myTeam: Team(name: "LA", recruitingPosition: ["4", "5"], location: "경기도 광명시", rating: "1200", teamImage: "team3"), matchDate: "201805011350", matchLocation: "경기도 광명시"),
        Match(myTeam: Team(name: "TORONTO", recruitingPosition: ["1", "3", "5"], location: "강원도 춘천시", rating: "1400", teamImage: "team4"), matchDate: "201805011350", matchLocation: "강원도 춘천시")
    ]
